 ...
 * @class
 *
 * @property {RCONClient} client - The RCON client instance associated with the message.
...
class RequestMessage {
   ...
   *
   * @param {RCONClient} client - The RCON client instance associated with the message.
   * @param {string} name - The name of the message.
   * @param {Object|string|null} [contentBody] - The content body of the message, can be an object, string, or null.
   */
