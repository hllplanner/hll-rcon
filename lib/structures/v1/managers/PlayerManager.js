...
class PlayerManager {
  ...
  async permaBan(playerId, reason, adminName) {
    ...
    const response = await this.client._send(`PermaBan ${intoQuotes(playerId)} ${intoQuotes(reason || "")} ${intoQuotes(adminName || "")}`);
  ...
  async removePermaBan(playerId) {
    ...
    const response = await this.client._send(`PardonPermaBan ${playerId}`);
  ...
  async switchTeamOnDeath(playerName) {
    ...
    const response = await this.client._send(`SwitchTeamOnDeath ${playerName}`);
  ...
  async switchTeamNow(playerName) {
    ...
    const response = await this.client._send(`SwitchTeamNow ${playerName}`);
  ...
  async addVIP(playerId, nickname) {
    ...
    const response = await this.client._send(`VipAdd ${intoQuotes(playerId)} ${intoQuotes(nickname || "")}`);
  ...
  async removeVIP(playerId) {
    ...
    const response = await this.client._send(`VipDel ${playerId}`);
