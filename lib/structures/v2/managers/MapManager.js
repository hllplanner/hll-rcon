...
class MapManager {
  ...
  async addMapToRotation(mapId, index) {
    ...
    if (response.statusCode === 200)
      ...
      throw new Error(`Error adding map to rotation: ${response.stringify()}`);
  }
  ...
  async removeMapFromRotation(index) {
    ...
    if (response.statusCode === 200)
      ...
      throw new Error(`Error removing map from rotation: ${response.stringify()}`);
  }
  ...
  async addMapToSequence(mapId, index) {
    ...
    if (response.statusCode === 200)
      ...
      throw new Error(`Error adding map to sequence: ${response.stringify()}`);
  }
  ...
  async removeMapFromSequence(index) {
    ...
    if (response.statusCode === 200)
      ...
      throw new Error(`Error removing map from sequence: ${response.stringify()}`);
  }
