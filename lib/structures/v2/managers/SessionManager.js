...
class SessionManager {
  ...
  async getSession() {
    ...
    if (response.statusCode === 200)
      ...
      throw new Error(`Error getting session: ${response.stringify()}`);
  }
  ...
  async setMap(id) {
    ...
    if (response.statusCode === 200)
      ...
      throw new Error(`Error setting map: ${response.stringify()}`);
  }
  ...
  async setSectorLayout(layout) {
    ...
    if (response.statusCode === 200)
      ...
      throw new Error(`Error changing sector layout: ${response.stringify()}`);
  }
  ...
  async broadcastMessage(message) {
    ...
    if (response.statusCode === 200)
      ...
      throw new Error(`Error broadcasting message: ${response.stringify()}`);
  }
}
