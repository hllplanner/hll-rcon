...
class AdminManager {
   ...
   * @returns {Promise<boolean>} A promise that resolves to `true` if the admin was added successfully.
   ...
   * @returns {Promise<boolean>} A promise that resolves to `true` if the admin was removed successfully.
   * @throws {Error} If the server responds with an error.
   */
