...
class ServerManager {
  ...
  async setWelcomeMessage(message) {
    ...
    const requestMessage = new RequestMessage(this.client, "SetWelcomeMessage", {
      Message: message
    });
   ...
   * The threshold is the biggest difference between player counts in each team before players are forced to the team with less players to even player count.
   *
