...
| <sub> Get Map                                               | <sub> Get Map                     | <sub> ✅           | <sub> GetServerInformation(name=session)     | <sub> ✅           | <sub> SessionManager  |
| <sub> Set Sector Layout                                     | <sub> GameLayout                  | <sub> ✅           | <sub> SetSectorLayout                        | <sub> ✅           | <sub> SessionManager  |
...
| <sub> List Current Map Sequence                             | <sub> ListCurrentMapSequence      | <sub> ✅           | <sub> GetServerInformation(name=mapsequence) | <sub> ✅           | <sub> MapManager      |
...
| <sub> Set Team Switch Cooldown                              | <sub> SetTeamSwitchCooldown       | <sub> ✅           | <sub> SetTeamSwitchCooldown                  | <sub> ✅           | <sub> ServerManager   |
...
| <sub> Get Max Queued Players                                | <sub> Get MaxQueuedPlayers        | <sub> ✅           | <sub> GetServerInformation(name=session)     | <sub> ✅           | <sub> ServerManager   |
...
| <sub> Get Current/Max Slots                                 | <sub> Get Slots                   | <sub> ✅           | <sub> GetServerInformation(name=session)     | <sub> ✅           | <sub> ServerManager   |
| <sub> Set Server/Welcome Message                            | <sub> Say                         | <sub> ✅           | <sub> SendServerMessage                      | <sub> ✅           | <sub> ServerManager   |
| <sub> Get Server Name                                       | <sub> Get Name                    | <sub> ✅           | <sub> GetServerInformation(name=session)     | <sub> ✅           | <sub> ServerManager   |
| <sub> Set Auto Balance Enabled                              | <sub> SetAutoBalanceEnabled       | <sub> ✅           | <sub> SetAutoBalance                         | <sub> ✅           | <sub> ServerManager   |
| <sub> Get Auto Balance Enabled                              | <sub> Get AutoBalanceEnabled      | <sub> ✅           | <sub> N/A*                                   | <sub> N/A*        | <sub> ServerManager   |
| <sub> Set Auto Balance Threshold                            | <sub> SetAutoBalanceThreshold     | <sub> ✅           | <sub> SetAutoBalanceThreshold                | <sub> ✅           | <sub> ServerManager   |
| <sub> Get Auto Balance Threshold                            | <sub> Get AutoBalanceThreshold    | <sub> ✅           | <sub> N/A*                                   | <sub> N/A*        | <sub> ServerManager   |
| <sub> Set Vote Kick Enabled                                 | <sub> SetVoteKickEnabled          | <sub> ✅           | <sub> SetVoteKick                            | <sub> ✅           | <sub> ServerManager   |
| <sub> Get Vote Kick Enabled                                 | <sub> Get VoteKickEnabled         | <sub> ✅           | <sub> N/A*                                   | <sub> N/A*        | <sub> ServerManager   |
| <sub> Set Vote to Kick Threshold                            | <sub> SetVoteKickThreshold        | <sub> ✅           | <sub> SetVoteKickThreshold                   | <sub> ✅           | <sub> ServerManager   |
...
| <sub> Add Profanities                                       | <sub> BanProfanity                | <sub> ✅           | <sub> AddBannedWords                         | <sub> ✅           | <sub> ServerManager   |
| <sub> Remove Profanities                                    | <sub> UnbanProfanity              | <sub> ✅           | <sub> RemoveBannedWords                      | <sub> ✅           | <sub> ServerManager   |
| <sub> Set Match Length                                      | <sub> N/A*                        | <sub> N/A*        | <sub> SetMatchTimer                          | <sub> ✅           | <sub> ServerManager   |
| <sub> Reset Match Length                                    | <sub> N/A*                        | <sub> N/A*        | <sub> RemoveMatchTimer                       | <sub> ✅           | <sub> ServerManager   |
| <sub> Set Warmup Length                                     | <sub> N/A*                        | <sub> N/A*        | <sub> SetWarmupTimer                         | <sub> ✅           | <sub> ServerManager   |
| <sub> Reset Warmup Length                                   | <sub> N/A*                        | <sub> N/A*        | <sub> RemoveWarmupTimer                      | <sub> ✅           | <sub> ServerManager   |
| <sub> Enable/Disable Dynamic Weather for Map                | <sub> N/A*                        | <sub> N/A*        | <sub> SetMapWeatherToggle                    | <sub> ✅           | <sub> ServerManager   |
| <sub> List Players                                          | <sub> Get Players / Get PlayerIDs | <sub> ✅           | <sub> GetServerInformation(name=players)     | <sub> ✅           | <sub> PlayerManager   |
| <sub> Get Detailed Player Information                       | <sub> PlayerInfo                  | <sub> ✅           | <sub> GetServerInformation(name=player)      | <sub> ✅           | <sub> PlayerManager   |
...
| <sub> Kick                                                  | <sub> Kick                        | <sub> ✅           | <sub> KickPlayer                             | <sub> ✅           | <sub> PlayerManager   |
| <sub> List Temporary Bans                                   | <sub> Get TempBans                | <sub> ✅           | <sub> N/A*                                   | <sub> N/A*        | <sub> PlayerManager   |
| <sub> Temporary Ban                                         | <sub> TempBan                     | <sub> ✅           | <sub> TemporaryBanPlayer                     | <sub> ✅           | <sub> PlayerManager   |
...
| <sub> Permanent Ban                                         | <sub> PermaBan                    | <sub> ✅           | <sub> PermanentBanPlayer                     | <sub> ✅           | <sub> PlayerManager   |
...
| <sub> Add VIP                                               | <sub> VipAdd                      | <sub> ✅           | <sub> AddVipPlayer                           | <sub> ✅           | <sub> PlayerManager   |
| <sub> Remove VIP                                            | <sub> VipDel                      | <sub> ✅           | <sub> RemoveVipPlayer                        | <sub> ✅           | <sub> PlayerManager   |
